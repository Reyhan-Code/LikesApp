...
class MainActivity : AppCompatActivity() {
    ...
    private fun showMouth(isHappy: Boolean) {
        ...
        when (isHappy) {
            ...
            // Ketika kondisinya positif (true), maka muncul bibir tersenyum
            true -> {
                mPaint.color = ResourcesCompat.getColor(resources, R.color.black, null)
            ...
            //Sebaliknya ketika kondisi negatif (false), akan muncul bibir cemberut alias sedih.
            false -> {
                mPaint.color = ResourcesCompat.getColor(resources, R.color.black, null)
